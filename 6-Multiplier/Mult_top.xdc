...
# Map the product output to the 16 LEDs
...
#set_property PACKAGE_PIN U19 [get_ports {product[2]}]					
	#et_property IOSTANDARD LVCMOS33 [get_ports {product[2]}]
#s#et_property PACKAGE_PIN V19 [get_ports {product[3]}]					
...
#	et_property IOSTANDARD LVCMOS33 [get_ports {product[13]}]
